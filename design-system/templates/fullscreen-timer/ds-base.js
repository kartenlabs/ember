...
(() => {
  const base = '../..';
  // Ember icons are masked SVGs loaded by URL; the Icon component reads this.
  window.EMBER_ICON_BASE = base + '/assets/icons';
  for (const p of ["tokens/fonts.css","tokens/colors.css","tokens/typography.css","tokens/spacing.css","tokens/edges.css","tokens/motion.css","tokens/base.css","styles.css"]) {
